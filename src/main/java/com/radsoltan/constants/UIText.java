...
public class UIText {
    ...
    public static final String INVALID_BEAM_FACE = "Invalid beam face.";
    ...
    public static final String INVALID_SHEAR_LINKS = "Invalid shear links";
    public static final String INVALID_SLAB_FACE = "Invalid slab face.";
